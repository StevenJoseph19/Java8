package com.mycompany.pension.withdrawal;
...
import static com.mycompany.pension.withdrawal.AccountClosingStatus.*;
...
public class AccountClosingService {
	...
	public AccountClosingResponse closeAccount(Account account) throws IOException {
		...
		if (accountHolderAge.getYears() < RETIREMENT_AGE) {
			...
			final BackgroundCheckResults backgroundCheckResults = backgroundCheckService.confirm(account.getFistName(),
					account.getLastName(), account.getTaxId(), account.getDob());
