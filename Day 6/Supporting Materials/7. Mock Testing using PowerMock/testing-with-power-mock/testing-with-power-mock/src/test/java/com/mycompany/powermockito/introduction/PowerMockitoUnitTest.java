...
@PrepareForTest(fullyQualifiedNames = "com.mycompany.powermockito.introduction.*")
public class PowerMockitoUnitTest {
	...
	public void givenFinalMethods_whenUsingPowerMockito_thenCorrect() throws Exception {
		...
		when(collaborator.helloMethod()).thenReturn("Hello Steve!");
		String welcome = collaborator.helloMethod();
		verify(collaborator).helloMethod();
		assertEquals("Hello Steve!", welcome);
	}
	...
	public void givenStaticMethods_whenUsingPowerMockito_thenCorrect() {
		...
		when(CollaboratorWithStaticMethods.firstMethod(Mockito.anyString())).thenReturn("Hello Steve!");
		...
		assertEquals("Hello Steve!", firstWelcome);
		assertEquals("Hello Steve!", secondWelcome);
